...
class RestController extends Controller
{
    ...
    protected function apiResponse($args,$code=200,$resultCode){
        $rs = array();
     ...
     * APP返回格式
     **/
    protected function apiAppSuccess($resultMessage="",$data=array(),$resultCode="1",$code=200){
        $rs = array();
    ...
    protected function apiAppError($resultMessage="",$data=array(),$resultCode="-1",$code=200){
        $rs = array();
        $rs['resultMessage'] = $resultMessage;
        $rs['data'] = $data;
        $rs['resultCode'] = $resultCode;
    ...
    protected function apiAppSuccessPage($resultMessage="",$data=array(),$data_2="",$resultCode="1",$code=200,$page='1'){
        $rs = array();
        $rs['resultMessage'] = $resultMessage;
        $rs['data'] = $data;
        $rs['data_2'] = $data_2;
